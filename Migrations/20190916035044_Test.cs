        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "varchar(40)", nullable: true),
                    QuestionId = table.Column<string>(nullable: true),
                    ResponseId = table.Column<string>(nullable: true),
                    CustomerId = table.Column<string>(nullable: true),
                    CustomerCustomAnswer = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(40)", nullable: true),
                    FullName = table.Column<string>(type: "varchar(70)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "varchar(40)", nullable: true),
                    ResponseId = table.Column<string>(nullable: true),
                    IsDateRequired = table.Column<bool>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    IsPredifinedResponse = table.Column<bool>(nullable: false),
                    DateSetWithClient = table.Column<DateTime>(nullable: true),
                    CustomerId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextQuestion = table.Column<string>(nullable: true),
                    QuestionId = table.Column<string>(nullable: true),
                    IsMetadataRequired = table.Column<bool>(nullable: false),
                    IsFillableByClient = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
